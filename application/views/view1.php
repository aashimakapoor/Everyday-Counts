...
<center>
<div class="row" style="width:800px;height:600px;background:rgba(0,0,0,0.7);color:white;margin-top:50px">
    <div class="col-xs-10 col-sm-10 col-md-10">
        <div>
        
            <h4><b style="padding:30px;color:#d84a4a">No. Of Correct Questions:</b></h4><br>
            <h4><b style="padding:30px;color:#d84a4a">No. Of InCorrect Questions:</b></h4>
