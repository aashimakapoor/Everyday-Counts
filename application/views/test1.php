...
<div class="row" style="background-color:rgba(0,0,0,0.8);color:white;padding:30px">
    ...
    <table >
       <?php foreach($ques as $q)
        {?>
         ...
         <tr style='text-align:left'><td><b><?php echo $q->question;?></b></td></tr>
          <tr style='text-align:left'><td><b><?php echo $q->optn1;?></b></td></tr>
          <tr style='text-align:left'><td><b><?php echo $q->optn2;?></b></td></tr>
          <tr style='text-align:left'><td><b><?php echo $q->optn3;?></b></td></tr>
          <tr style='text-align:left'><td><b><?php echo $q->optn4;?></b></td></tr>
          <tr><td><b style="color:#d84a4a">Ans :</b> <b><input type="text" id="ans" name="ans" style="width:40px;height:30px;background:rgba(0,0,0,0.1);color:white"></input></b></td></tr>
   ...
   <center> <input type="submit" value="submit"  name="submit"  style="width:100px;height:30px;background-color:#d84a4a;color:white"></input></center>
    </form>
</div>
</div>
